...
class Couchdb < Formula
  ...
  def caveats; <<-EOS.undent
    If this is your first install, automatically load on login with:
        ...
        ln -s #{opt_prefix}/Library/LaunchDaemons/org.apache.couchdb.plist ~/Library/LaunchAgents
        launchctl load -w ~/Library/LaunchAgents/org.apache.couchdb.plist

    If you just upgraded and org.apache.couchdb.plist is already loaded:
    ...
    Alternatively, automatically run on startup as a daemon with:
        ...
        sudo cp #{opt_prefix}/Library/LaunchDaemons/org.apache.couchdb.plist /Library/LaunchDaemons/
